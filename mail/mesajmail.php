...
$mail->Body = "<h1> Dear $kulname, </h1> <b>  <h1>You have an unread new message on penpaljourney! You can use that quick link to login .('http://penpaljourney.com/login.php') "." <h1>Looking forward
