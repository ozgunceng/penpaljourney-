            ...
            <div id="chat-block">
              ...
              <ul class="online-users list-inline">
               ...
               <br>
                ...
                <center>  <h4 class="grey2">  LAST  <b class="boldie">100</b> LOGIN  </h4> <BR> </center>
                </div>
            <hr>

 <?php 

  $lastloginsor=$db->prepare("SELECT * FROM lastlogin order by last_time DESC limit 100");
...
?> 
                </b><br><br><b>      <?php echo $lastkullanicicek['kullanici_country']; ?></b> <img src="images/flags/<?php echo $lastkullanicicek['kullanici_country']; ?>.png" /><br><br>

                     looking for <a><b><?php echo $lastkullanicicek['kullanici_lookGen']; ?></a></b> between <b> <?php echo $lastkullanicicek['kullanici_lookAgeOne']; ?></b> and <b><?php echo $lastkullanicicek['kullanici_lookAgeTwo']; ?></b></h4>
