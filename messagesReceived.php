...
include 'header.php';
 ...
 <?php 
  ...
  $mesajsor=$db->prepare("SELECT * FROM mesaj where kullanici_gel=:kullanici_gel group by kullanici_gon  order by mesaj_zaman DESC limit 7");
...
while($mesajcek=$mesajsor->fetch(PDO::FETCH_ASSOC)) { 
 ...
 $lastkullanicicek=$lastkullanicisor->fetch(PDO::FETCH_ASSOC);
        $say++;?>
                    ...
                    <li>
                      <a href="messageDetail.php?kullanici_gel=<?php echo $mesajcek['kullanici_gel']?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon']?>" >
                        <div class="contact">
       ...
       <img src="
               ...
               ?> "  alt=""  class="profile-photo-sm pull-left"/>
                          <div class="msg-preview">
                            ...
                            $lastmesajsor=$db->prepare("SELECT * FROM mesaj where kullanici_gon=$kullanici_gon2 and kullanici_gel=$kullanici_gel2 or kullanici_gon=$kullanici_gel2 and kullanici_gel=$kullanici_gon2 order by mesaj_okunma,mesaj_zaman Desc");
                            ...
                            echo substr($lastmesajcek['mesaj_detay'],0,30)?>...</p>
...
<?php  echo date("Y", strtotime($mesajcek['mesaj_zaman'])); ?>
                            ...
                            if($lastmesajcek['mesaj_okunma']==0 && $_SESSION['userkullanici_id']!=$lastmesajcek['kullanici_gon']) {?>
                            <div class="chat-alert fontbigger">New</div>
