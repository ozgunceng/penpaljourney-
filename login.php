              ...
              <li class="dropdown"><a href="index.php">Learn More</a></li>
               <li class="dropdown">
                ...
                <ul class="dropdown-menu page-list">
                  ...
                  <li class="dropdown"><a href="validate.php"><button class="btn btn-primary">Validate</button></a></li> 
                  <br>
                </ul>
              </li>
            </ul>
                ...
                <div class="tab-pane active" id="login">
                  ...
                  <p class="text-muted">Login to your account</p>
                      ...
                      <div class="alert alert-danger">
                        <strong>HALT!</strong> Something is wrong.<BR> Maybe you forget your password. Try again or reset your password below.
                      </div>
                  ...
                  <form action="nedmin/netting/islem.php" method="POST" role="form" name="Login_form" id='Login_form'>
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="my-password" required="required" class="form-control input-group-lg" type="password" name="kullanici_password" title="Enter password" placeholder="Password"/>
                      </div>
                    </div>
