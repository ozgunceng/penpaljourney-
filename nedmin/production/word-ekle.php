...
<div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">word Detay <span ></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="word_detay" value="Detayları Gir"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
             ...
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="wordekle" class="btn btn-success">Kaydet</button>
              </div>
            </div>
