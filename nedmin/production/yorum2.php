...
$yorumsor=$db->prepare("SELECT * FROM comment2 order by com2_zaman DESC");
$yorumsor->execute();
  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Kelime Yorum Listeleme <small>,
          ...
          <div class="x_content">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <?php  echo nl2br( substr($yorumcek['com2_detay'], 0,500) ); ?>
            ...
            <td><center><a href="../netting/islem.php?com2_id=<?php echo $yorumcek['com2_id']; ?>&com2sil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
          </tr>
