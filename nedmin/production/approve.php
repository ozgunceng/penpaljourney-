...
$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_fotonay='0' order by kullanici_zaman DESC");
...
<div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                while($kullanicicek=$kullanicisor->fetch(PDO::FETCH_ASSOC) and $kullanicicek['kullanici_foto']!=NULL ) {?>
 ...
 <?php  echo date("Y", strtotime($kullanicicek['kullanici_zaman'])); ?>
       ...
       <img src="
               <?php echo "../../".$kullanicicek['kullanici_foto']; ?> "  alt="" class="img-responsive profile-photo"  width="250px" height="250px" class="img-responsive profile-photo"></td>
                 ...
                 <a href="../netting/islem.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']  ?>&kullanici_fotonay=1&foto_onay2=ok"><button class="btn btn-warning btn-xs">Unapproved</button></a>
                   

                 <?php } elseif ($kullanicicek['kullanici_fotonay']==1) {?>


                 <a href="../netting/islem.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']  ?>&kullanici_fotonay=0&foto_onay2=ok"><button class="btn btn-success btn-xs">Approved</button></a>
