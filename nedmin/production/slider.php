            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              <thead>
                <tr>
                 ...
                 <!-- slider açıklama ve fiyat ekledim bunları ana ekrana çekecem -->
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <!-- slider açıklama ve fiyat ekledim bunları ana ekrana çekecem ekrana yazdırdıklarım burada -->


                  <td><?php echo $slidercek['slider_aciklama'] ?></td>
                  <td><?php echo $slidercek['slider_fiyat'] ?></td>
