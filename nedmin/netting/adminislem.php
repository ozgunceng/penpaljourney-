...
if (isset($_POST['kullaniciresimguncelle'])) {
	...
	if ($_FILES['kullanici_foto']['size']>1048576) {
		...
		echo "File Size is Too Much";

		Header("Location:../../upload.php?durum=filesize");
	...
	if (in_array($ext, $izinli_uzantilar) === false) {
		echo "This file type is not enable";
		Header("Location:../../upload.php?durum=format");
	...
	if ($update) {
		...
		Header("Location:../../upload.php?durum=ok");

	} else {

		Header("Location:../../upload.php?durum=hata");
	}
