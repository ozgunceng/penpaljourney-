...
<html lang="en">
	<head>
		...
		<meta name="description" content="Get A Penpal!" />
		<meta name="keywords" content="Social Network, Social Media, Make Friends, Newsfeed, Profile Page" />
		<meta name="robots" content="index, follow" />
		<title>Edit Profile | Profile Picture</title>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <ul class="edit-menu">
              	...
              	<li class="active" ><ion-icon name="image-outline"></ion-icon><a href="edit-profile-interests.html">Upload Picture</a></li>
            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                <div class="block-title">
                  <h4 class="grey"><ion-icon name="image-outline"></ion-icon> Profile picture</h4>
                  <div class="line fontbigger2"></div>
                  <p>You can upload your profile picture here. Do not forget, until valitadion by administrator It won't be shown.</p>
                  <div class="line"></div>
                </div>
                <div class="edit-block">
                  ...
                  <div class="line"></div>
                  <div class="row">
                    <p class="custom-label"><strong>Upload Profile Picture</strong></p>
