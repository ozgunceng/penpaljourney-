                  ...
                  <form name="registration_form" id='registration_form' class="form-inline">
                     <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="username" class="form-control input-group-lg" type="text" name="username" title="Username" placeholder="Username"/>
                      </div>
                    </div>
                 ...
                 <!--   <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="email" class="form-control input-group-lg" type="text" name="Email" title="Enter Email" placeholder="Your Email" required="required" />
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="password" class="form-control input-group-lg" type="password" name="password" title="Enter password" placeholder="Password Again"/>
                      </div>
                    </div>
                  ...
                  <form name="Login_form" id='Login_form'>
                     <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input required="required" id="my-email" class="form-control input-group-lg" type="mail" name="Email" title="Enter Email" placeholder="Your Email"/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
